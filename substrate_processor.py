...
df=pd.read_csv('../data/train_1357.csv', sep=',')


# In[6]:


#df=df.rename(columns={0:'ID',1:'density',2:'smiles'})
...
#torch.save(model, 'saved_models/model_'+prefix_filename+'_'+start_time+'_'+str(71)+'.pt')
#torch.save(model, 'saved_models/model_'+str(71)+'.pt')
